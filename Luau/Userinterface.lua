...
local BtnLock = CreateActionButton("Unlock", 5, 40, Color3.fromRGB(60, 60, 70))
...
BtnLock.MouseButton1Click:Connect(function()
    ...
    if isMenuLocked then BtnLock.Text = "Locked" else BtnLock.Text = "Unlock" end
end)
