...
-- Create a scrolling frame inside TabContainer to hold all tabs
local TabScroller
do
...
-- Move all existing tabs into the scroller
...
-- Remove any layout from TabContainer to avoid interference
...
-- Collect initial native tabs from the scroller
...
local function BuildTabButton(name, title, icon)
    ...
    local btn = New("TextButton", {
        Name = name,
        Size = UDim2.new(0, 120, 1, 0), -- fixed width, will be adjusted later
        BackgroundTransparency = 1,
        Text = "",
